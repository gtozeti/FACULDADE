public class PlanoB extends Beneficiario{
    ...
    public String toString(){
        return String.format("\n%s, solicitou os seguintes reembolsos, R$ %.2f para o Exame e R$ %.2f para o Procedimento. Status da solicitação: %s.",super.toString(), getReembolsoExame(), getReembolsoProcedimento(), autorizaConsulta());
    }
